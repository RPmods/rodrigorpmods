...
## Hotfix v3.4.18 Draft Flow Real Wiring + Chibi Audio/Assist UI
...
## Hotfix v3.4.18 Tournament Isolation + Button Recovery
...
## v3.4.18 — Draft Flow Core Rebuild
...
## v3.4.18
- Bots con preselección visible.
- Espera de 5 segundos antes de confirmar picks/bans.
- No cambia el flujo secuencial estable de v3.4.18.


## v3.4.18
- Corrige el orden de PEDIR: primero se activa PEDIR y luego el miembro elige el laminante.
- Limpia preselecciones previas para no tomar por error la selección del capitán/subcapitán.
- Añade estado visual de modo PEDIR activo.


## v3.4.18
- PEDIR ahora funciona como capa separada del turno activo.
- No usa CONFIRMAR.
- No modifica la preselección del capitán/subcapitán.
- Se oculta para espectadores.
